        ...
        if context:
            ...
            if language == 'en':
                system_prompt += (
                    ...
                    "- Never infer a country from a place name. Only use country-specific information (shipping "
                    "costs, delivery times) when the customer states the country explicitly\n"
                    "- Never speculate\n"
                ...
                system_prompt += (
                    ...
                    "- Leid nooit een land af uit een plaatsnaam. Alleen als de klant het land expliciet noemt "
                    "gebruik je landspecifieke informatie (verzendkosten, levertijden)\n"
