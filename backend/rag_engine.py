        ...
        if context:
            ...
            if language == 'en':
                system_prompt += (
                    ...
                    "If you notice that you have failed to help the customer across multiple consecutive turns (e.g. repeatedly stating you don't have pricing information), proactively ask: 'I notice my answers aren't helping you. Would you like to speak with a colleague?' Once the customer responds affirmatively (e.g. 'yes', 'please', 'sure'), respond with EXACTLY: __HUMAN_REQUESTED__\n"
