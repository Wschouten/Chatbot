        ...
        if context:
            ...
            if language == 'en':
                system_prompt += (
                    ...
                    "is not a knowledge question. Acknowledge it briefly, then give the relevant answer again; "
                    "never reply with just 'I can't see that from here'\n"
                ...
                system_prompt += (
                    ...
                    "is geen kennisvraag. Reageer kort en geef daarna opnieuw het antwoord dat erbij hoort; "
                    "antwoord nooit alleen met 'dat kan ik hier niet zien'\n"
